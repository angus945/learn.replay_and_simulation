...
{
    public class OnCollisionStayEvent : MonoBehaviour, IUnityCollisionRecordPort
    {
        ...
        {
            collisionRecordCallback?.Invoke(this.gameObject, collision.gameObject, ContactPhase.Stay);
        }
    }
}
