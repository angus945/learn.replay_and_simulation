...
從 [Arena 固定 tick 接線](../../docs/arena-guide/03-simulation.md)開始：Definition 完成必要接點，框架負責 Build／Seal、Step、Reset、Stop、Dispose 與失敗鎖定。
...
- `src/API/RealtimeSimulationRunner.cs`：frame delta 累積、bounded catch-up、Pause／Resume 與獨占 tick 驅動權；見 [使用指引](../../docs/arena-guide/09-realtime.md)。
