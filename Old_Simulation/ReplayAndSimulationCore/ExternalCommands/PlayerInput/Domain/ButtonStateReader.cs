using SimulationCore.ExternalCommands.PlayerInput;

namespace SimulationCore.ExternalCommands.PlayerInput.Domain
{
    public sealed class ButtonStateReader
    {
        ...
        /// Down 狀態則會持續存在。
        /// </summary>
        public ButtonInputState ConsumeTickInput()
        {
            ButtonInputState result = new ButtonInputState(
